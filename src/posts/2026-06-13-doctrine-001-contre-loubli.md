...
date: "2026-06-13"
status: "draft"
description: "Doctrine 001: toward an architecture of memory. Against forgetting."
tags:
  - doctrine
  - systems
  - memory
...
1. **Preservation** — the record survives.
2. **Provenance** — the record knows where it came from.
3. **Retrieval** — the record can be found when needed.
4. **Interpretation** — the record can be understood by someone who was not there.
5. **Transmission** — the record can be passed forward.
6. **Reconstruction** — from the record, the lost thing can be partially recovered.
