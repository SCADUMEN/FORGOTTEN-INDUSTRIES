...
SOURCE_FILES = [
  { "label" => "projects", "path" => "src/projects.yml" },
  { "label" => "inventory", "path" => "src/inventory.yml" },
  { "label" => "fieldLogs", "path" => "src/field-logs.yml" },
  { "label" => "socialPosts", "path" => "src/social-posts.yml" }
].freeze
...
projects_path = File.join(ROOT, "src/projects.yml")
inventory_path = File.join(ROOT, "src/inventory.yml")
field_logs_path = File.join(ROOT, "src/field-logs.yml")
social_posts_path = File.join(ROOT, "src/social-posts.yml")
